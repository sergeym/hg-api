 ...
 */
class Version20160714235108 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE hg05_activity_equipment (activity_id INT NOT NULL, equipment_id INT NOT NULL, INDEX IDX_114C9D1E81C06096 (activity_id), INDEX IDX_114C9D1E517FE9FE (equipment_id), PRIMARY KEY(activity_id, equipment_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE hg05_activity_equipment ADD CONSTRAINT FK_114C9D1E81C06096 FOREIGN KEY (activity_id) REFERENCES hg05_xc_activity (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE hg05_activity_equipment ADD CONSTRAINT FK_114C9D1E517FE9FE FOREIGN KEY (equipment_id) REFERENCES hg05_xc_equipment (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE hg05_activity_equipment DROP FOREIGN KEY FK_114C9D1E81C06096');
        ...
        $this->addSql('ALTER TABLE hg05_activity_equipment DROP FOREIGN KEY FK_114C9D1E517FE9FE');
        ...
        $this->addSql('DROP TABLE hg05_activity_equipment');
